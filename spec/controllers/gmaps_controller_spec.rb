  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved gmap as @gmap" do
        ...
        post :create, {:gmap => { "name" => "invalid value" }}, valid_session
        assigns(:gmap).should be_a_new(Gmap)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested gmap" do
        ...
        Gmap.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => gmap.to_param, :gmap => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the gmap as @gmap" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Gmap.any_instance.stub(:save).and_return(false)
        put :update, {:id => gmap.to_param, :gmap => { "name" => "invalid value" }}, valid_session
        assigns(:gmap).should eq(gmap)
      end
